...
app.post("/historical", async (req, res) => {
  ...
  // let reformated = await historicalArray.forEach(object => {
  //   const sortedData = [];
  //   let count = 0;
  //   sortedData.push({
  //     d: moment(object.time * 1000).format("MMM DD YYYY"),
  //     c: object.close.toLocaleString("us-EN", {
  //       style: "currency",
  //       currency: "USD"
  //     }),
  //     o: object.open.toLocaleString("us-EN", {
  //       style: "currency",
  //       currency: "USD"
  //     }),
  //     h: object.high.toLocaleString("us-EN", {
  //       style: "currency",
  //       currency: "USD"
  //     }),
  //     l: object.low.toLocaleString("us-EN", {
  //       style: "currency",
  //       currency: "USD"
  //     }),
  //     x: count,
...
//   // let timeInterval = "months";
//   // let ticker =
//   //   "BTC,ETH,EOS,LTC,XRP,BCH,ETC,OKB,NEO,ZEC,BNB,DASH,TRX,QTUM,XLM,BGG,HT,XMRADA,BSV,BZ,PAX,PPT,USDT,ENJ,OMG,ABT";
//   // let result = await cc.priceHistorical("BTC", "USD");
//   let promises = [];
//   for (let units = 10; units > 0; units--) {
//     let results = await cc.priceHistorical(
//       ["BTC"],
//       ["USD"],
//       moment()
